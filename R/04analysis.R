...
fig2year <- plot_model(m01,type = "pred",
  ...
  scale_x_discrete(name = "",limits = c("2009-01-01", "2019-01-01"),labels = c("2009", "2019")) + 
...
figure3 <- gridExtra::grid.arrange(fig2class, fig2union, fig2year, layout_matrix=layout)

### Guardar
ggsave(figure3, filename = "output/images/figure3B.png",
...
ggplot(dat, aes(x, predicted, shape = group, color = group)) +
  ...
  scale_x_discrete(name = "",
                   ...
                   labels = c("1. Empresarios", "2.Pequeños empleadores", "3.Pequeña burguesía formal", "4.Expertos Directivos", "5.Expertos sin autoridad", "6.Supervisores calificados", "7.Supervisores no calificados", "8.Trabajadores calificados","9.Trabajadores no calificados", "10.Autoempleados informales")) +
...
ggsave(plot = last_plot(), filename = "output/images/figure4B.png",
       device = "png",dpi = "retina", units = "cm",
       width = 27,height = 15)
...
ggplot(dat, aes(x, predicted, shape = group, color =group)) +
  ...
  scale_shape_discrete(name = "",
                       ...
                       labels = c("2009", "2019")) +
  scale_x_discrete(name = "",limits =c("No", "Si"),labels = c("No sindicalizado", "Sindicalizado")) +
  scale_color_grey(name = "",limits = c("2009-01-01", "2019-01-01"),
                   labels = c("2009", "2019"))+ labs(y = "")

ggsave(plot = last_plot(), filename = "output/images/figure5B.png",
       device = "png",dpi = "retina", units = "cm",
       width = 27,height = 15)
