...
fig2class <-  plot_model(m01,type = "pred",
  ...
  scale_x_discrete(name = "",limits = c("1.Capitalists", "2.Small employers","3.Petite bourgeoisie","4.Expert managers", "5.Nonmanagerial experts", "6.Skilled supervisors", "7.Unskilled supervisors", "8.Skilled workers", "9.Unskilled workers", "10. Informal self-employed"), labels = c("1.Capitalists", "2.Small\nemployers", "3.Petite\nbourgeoisie", "4.Expert\nsupervisors", "5.Nonmanagerial\nexperts", "6.Skilled\nsupervisors", "7.Unskilled\nsupervisors", "8.Skilled\nworkers","9.Unskilled\nworkers", "10.Informal\nself-employed")) + scale_y_continuous(limits = c(0.1,0.8), labels = scales::percent_format()) +
  geom_line() +
...
fig2union <- plot_model(m01,type = "pred",
           terms = c("union"), 
           title = "Unionization", axis.title = "") + scale_x_discrete(name = "",limits =c("No", "Si"),labels = c("No union member", "Union member"))  + scale_y_continuous(limits = c(0.1,0.8), labels = scales::percent_format()) + 
  geom_line()
...
ggplot(dat, aes(x, predicted, shape = group, color =group)) +
  ...
  scale_x_discrete(name = "",limits = c("1.Capitalists", "2.Small employers","3.Petite bourgeoisie","4.Expert managers", "5.Nonmanagerial experts", "6.Skilled supervisors", "7.Unskilled supervisors", "8.Skilled workers", "9.Unskilled workers", "10. Informal self-employed"), labels = c("1.Capitalists", "2.Small employers","3.Petite bourgeoisie","4.Expert managers", "5.Nonmanagerial experts", "6.Skilled supervisors", "7.Unskilled supervisors", "8.Skilled workers", "9.Unskilled workers", "10. Informal self-employed")) +  scale_color_grey(name = "",limits = c("1999-01-01", "2009-01-01", "2019-01-01"),labels = c("1999", "2009", "2019")) +
  labs(y = "") +
...
ggplot(dat, aes(x, predicted, shape = group, color =group)) +
  ...
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high),
    position = position_dodge(.1))  + 
  scale_shape_discrete(name = "",limits = c("1999-01-01", "2009-01-01", "2019-01-01"),labels = c("1999", "2009", "2019")) + scale_x_discrete(name = "",limits =c("No", "Si"),labels = c("No union member", "Union member")) +  scale_color_grey(name = "",limits = c("1999-01-01", "2009-01-01", "2019-01-01"),labels = c("1999", "2009", "2019"))+ labs(y = "")
