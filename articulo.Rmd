...
[^2]: Los procedimientos realizados para la construcción de la base de datos, análisis y escritura del artículo se encuentran abiertos y disponibles en el repositorio *Open Source Framework* (OSF) doi (indicar). 
